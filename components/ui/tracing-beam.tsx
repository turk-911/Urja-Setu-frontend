        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2} 
            >
              <stop stopColor="#006400" stopOpacity="0"></stop>
              <stop stopColor="#006400"></stop>
              <stop offset="0.325" stopColor="#228B22"></stop>
              <stop offset="1" stopColor="#32CD32" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
